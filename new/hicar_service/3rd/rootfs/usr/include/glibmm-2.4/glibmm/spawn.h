...
enum SpawnFlags
{
   ...
   * or handle <tt>SIGCHLD</tt> yourself), or the child will become a zombie.
   */
  SPAWN_DO_NOT_REAP_CHILD = 1 << 1,
  /** <tt>argv[0]</tt> need not be an absolute path,
  ...
  /** the first element of <tt>argv</tt> is
  ...
  /** if <tt>argv[0]</tt> is not an abolute path,
   * it will be looked for in the <tt>PATH</tt> from the passed child 
   * environment. @newin{2,34}
   */
...
public:
  enum Code
  {
     ...
     */
    CHDIR,
    /** execv() returned <tt>EACCES</tt>
     */
    ACCES,
    /** execv() returned <tt>EPERM</tt>
     */
    PERM,
    /** execv() returned <tt>E2BIG</tt>
     */
    TOO_BIG,
    /** deprecated alias for SPAWN_ERROR_TOO_BIG
     */
    TOOBIG = TOO_BIG,
    /** execv() returned <tt>ENOEXEC</tt>
     */
    NOEXEC,
    /** execv() returned <tt>ENAMETOOLONG</tt>
     */
    NAMETOOLONG,
    /** execv() returned <tt>ENOENT</tt>
     */
    NOENT,
    /** execv() returned <tt>ENOMEM</tt>
     */
    NOMEM,
    /** execv() returned <tt>ENOTDIR</tt>
     */
    NOTDIR,
    /** execv() returned <tt>ELOOP</tt>
     */
    LOOP,
    /** execv() returned <tt>ETXTBUSY</tt>
     */
    TXTBUSY,
    /** execv() returned <tt>EIO</tt>
     */
    IO,
    /** execv() returned <tt>ENFILE</tt>
     */
    NFILE,
    /** execv() returned <tt>EMFILE</tt>
     */
    MFILE,
    /** execv() returned <tt>EINVAL</tt>
     */
    INVAL,
    /** execv() returned <tt>EISDIR</tt>
     */
    ISDIR,
    /** execv() returned <tt>ELIBBAD</tt>
     */
    LIBBAD,
    /** Some other fatal failure,
     * <tt>error->message</tt> should explain.
     */
    FAILED
  };
