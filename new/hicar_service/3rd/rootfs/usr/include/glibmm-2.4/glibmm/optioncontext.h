...
public:
  ...
  /** Enables or disables automatic generation of <tt>--help</tt>
   * output. By default, g_option_context_parse() recognizes
   * <tt>--help</tt>, <tt>-h</tt>,
   * <tt>-?</tt>, <tt>--help-all</tt>
   * and <tt>--help-</tt><em>groupname</em> and creates
   * suitable output to stdout.
   * 
   * @newin{2,6}
   * @param help_enabled <tt>true</tt> to enable <tt>--help</tt>, <tt>false</tt> to disable it.
   */
  void set_help_enabled(bool help_enabled =  true);
  
  /** Returns whether automatic <tt>--help</tt> generation
   ...
   * 
   * If automatic <tt>--help</tt> support is enabled
   ...
   * To obtain the text produced by <tt>--help</tt>, call
   * <tt>g_option_context_get_help (context, <tt>true</tt>, <tt>0</tt>)</tt>.
   * To obtain the text produced by <tt>--help-all</tt>, call
