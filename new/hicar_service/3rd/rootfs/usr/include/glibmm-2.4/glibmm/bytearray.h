...
public:
  ...
  /** Adds the given bytes to the end of the ByteArray. The array will
  ...
  /** Adds the given data to the start of the ByteArray. The array will
   * grow in size automatically if necessary.
   * @param data The byte data to be added.
   * @param len The number of bytes to add.
   * @return The ByteArray.
  ...
  /** Removes the byte at the given index from a ByteArray. The
